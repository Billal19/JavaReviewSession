...
public class HashMapConcept {
    ...
    public static void main(String[] args) { //
        ...
        //capitalCities.put("USA","Jersey"); // As we previously mentioned that HashMap takes only unique keys , howerver it is possible to create duplicated keys , but they will not be considered , only the last added one that's going to be considered
        ...
        System.out.println(capitalCities.containsKey("Algeria")); // this method is used to check if the key exits or not , it will return a boolean type ( true or false )
        System.out.println(capitalCities.containsValue("Algiers"));// this method is used to check if the value exists or not , it will return a boolean type( true or false)
